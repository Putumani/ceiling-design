...
const Services = () => {
  ...
  const serviceCategories = [
    ...
    { 
      title: "Partitioning & Drywalls", 
      // Keeping the high-end external unsplash image for this section as requested
      image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&q=80",
      items: ["Office & Home Partitioning", "Drywall Installations", "Wall Panel Decor", "Professional Wallpapering"] 
    },
    { 
      title: "Home Fittings & Tiling", 
      image: homeFittingImg,
      items: ["Expert Floor & Wall Tiling", "Interior/Exterior Painting", "Kitchen Units & Cupboards", "Door Installations"] 
    }
  ];
        ...
        <div className="flex flex-col md:flex-row items-baseline gap-6 mb-16 border-t border-gray-100 pt-10">
          ...
          <div className="max-w-2xl">
             ...
             <p className="text-navy/70 text-sm md:text-base leading-loose font-medium">
                At Fantastic Ceilings, we provide a complete ecosystem of interior solutions. 
